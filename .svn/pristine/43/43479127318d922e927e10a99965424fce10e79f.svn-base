 ...
 *
 */
public class ControlPtzRequest implements KvmSerializable {
	...
	/**
	 * @param ptzDirection the ptzDirection to set
	 */
	public void setPtzDirection(int ptzDirection) {
